...
const DigitarCode = ({navigation}) =>{
  ...
  return (
    ...
    <TextInput
    style={{width: '70%', height: '25%', borderRadius: 4,borderWidth: 2.5, borderColor: '#C4C4C4'}}
    />

    <View style={{ width: '100%', height: '40%', alignItems: 'center', justifyContent: 'space-around'}}>
    <TouchableOpacity
    onPress={() => DataeHora()}
     style={{width: '45%', height: '15%', backgroundColor: '#2ECC71', borderRadius: 8, alignItems: 'center', justifyContent: 'center',}}>
        <Text style={{fontWeight: 'bold', fontFamily: 'Segoe UI', color: 'white'}}>Prosseguir</Text>
    </TouchableOpacity>

    <TouchableOpacity
     onPress={() => ImagemCamera() }
     style={{width: '45%', height: '15%', backgroundColor: '#3071D3', borderRadius: 8, alignItems: 'center', justifyContent: 'center',}}>
        <Text style={{fontWeight: 'bold', fontFamily: 'Segoe UI', color: 'white'}}>Escanear código</Text>
    </TouchableOpacity>

    <TouchableOpacity
    onPress={() => Home() }
    style={{width: '45%', height: '15%', backgroundColor: '#E92525', borderRadius: 8, alignItems: 'center', justifyContent: 'center',}}>
