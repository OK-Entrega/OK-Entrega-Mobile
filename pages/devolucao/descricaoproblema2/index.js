...
const DescricaoProblema2 = ({navigation}) =>{
...
const tirarFoto = async ()=>{
  ...
  return (
      <View style={{ flex: 1}}> 
        ...
        <Text style={{color: 'white',fontWeight: 'bold', fontFamily: 'Segoe UI'}}> Descrição do problema</Text>
...
export default DescricaoProblema2;