...
import FotoDosProdutos from '../fotodosprodutos';

const FotoCanhoto = ({navigation}) =>{
...
const FotoCanhoto2 =(foto)=>{
    navigation.navigate('fotocanhoto2');
...
const tirarFoto = async ()=>{
  ...
  return (
    ...
    >
        ...
        <Text style={{fontWeight: 'bold', fontFamily: 'Segoe UI', color: 'white'}}>Tirar depois</Text>
    </TouchableOpacity>
