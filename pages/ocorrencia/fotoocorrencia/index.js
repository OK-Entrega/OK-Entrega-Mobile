...
const FotoOcorrencia = ({ navigation, route }) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <View style={styles.nav}>
                ...
                <Text style={{ color: 'white', fontWeight: 'bold', fontFamily: 'Segoe UI' }}> Tire uma foto da ocorrência (opcional)</Text>
