...
const FotoOcorrencia2 = ({navigation}) =>{
...
const tirarFoto = async ()=>{
  ...
  return (
      <View style={{ flex: 1}}> 
        ...
        <Text style={{color: 'white',fontWeight: 'bold', fontFamily: 'Segoe UI'}}> Confira a foto da ocorrência</Text>
...
export default FotoOcorrencia2;