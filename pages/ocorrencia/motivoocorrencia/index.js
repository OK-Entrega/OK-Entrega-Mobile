...
const MotivoOcorrencia = ({ navigation, route }) => {
    ...
    const prosseguir = () => {
        if (reasonOccurrence === -1)
            Toast.show({
                text1: "Campos obrigatórios",
                text2: "Informe a data e a hora da ocorrência!",
                type: "error"
            });
        else
    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white', }}>
            ...
            <View style={styles.nav}>
                ...
                <Text style={styles.textodbutton}> Motivo da ocorrência</Text>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Text style={[styles.title, { marginVertical: 30 }]}>Motivo da ocorrência</Text>
...
export default MotivoOcorrencia;